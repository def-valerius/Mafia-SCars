...
ENT.DefaultSound = "mafia/arrow_X.wav"
ENT.EngineEffectName = "Mafia"
ENT.HornSound = "mafia/horn14.wav"

ENT.CarModel = "models/mafia/arrow.mdl"
ENT.TireModel = "models/mafia/arrow_wheel.mdl"
ENT.AnimType = 1

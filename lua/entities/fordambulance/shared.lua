...
ENT.CarModel = "models/mafia/ambulance.mdl"
...
function ENT:Initialize()
	...
	if (SERVER) then
		self.SirenSound = CreateSound(self.Entity,"mafia/sirene2.wav")
